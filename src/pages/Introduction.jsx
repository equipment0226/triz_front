...
export default function Introduction({ solve, route, onNavigate }) {
  ...
  const go = (values = {}) => onNavigate({page:'Introduction',introTab:values.topic || 'tool',chapter:values.chapter,material:values.material,standard:values.standard,principle:values.principle,effect:values.effect}, {scrollTop:!values.standard && !values.principle && !values.effect});
